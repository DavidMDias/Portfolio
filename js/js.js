...
function btnsVideo()
{
	...
	document.querySelector(".video4").addEventListener("mousedown", function(){
		...
		document.querySelector(".fenetreVideo4").getElementsByTagName("iframe")[0].src="https://www.youtube.com/embed/JnC1FgiSUC0?rel=0";
	});
	...
	document.querySelector(".video2").addEventListener("mousedown", function(){
		...
		document.querySelector(".fenetreVideo2").getElementsByTagName("iframe")[0].src="https://www.youtube.com/embed/PtWWvatarlI?rel=0";
	});
